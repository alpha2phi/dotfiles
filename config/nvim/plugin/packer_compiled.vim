...
_G.packer_plugins = {
  ...
  rnvimr = {
    loaded = true,
    path = "/Users/mengwangk/.local/share/nvim/site/pack/packer/start/rnvimr"
  },
  ["sql.nvim"] = {
    loaded = true,
  ...
  ["vim-argwrap"] = {
    loaded = true,
    path = "/Users/mengwangk/.local/share/nvim/site/pack/packer/start/vim-argwrap"
  },
  ["vim-boxdraw"] = {
    loaded = true,
  ...
  vimux = {
    loaded = true,
    path = "/Users/mengwangk/.local/share/nvim/site/pack/packer/start/vimux"
  },
  ["vscode-go"] = {
    loaded = true,
