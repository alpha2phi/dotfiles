...
_G.packer_plugins = {
  ...
  ["vim-pad"] = {
    loaded = true,
    path = "/Users/mengwangk/.local/share/nvim/site/pack/packer/start/vim-pad"
  },
  ["vim-pandoc"] = {
    loaded = true,
  ...
  ["vim-pandoc-after"] = {
    loaded = true,
    path = "/Users/mengwangk/.local/share/nvim/site/pack/packer/start/vim-pandoc-after"
  },
  ["vim-pandoc-syntax"] = {
    loaded = true,
  ...
  ["vim-table-mode"] = {
    loaded = true,
    path = "/Users/mengwangk/.local/share/nvim/site/pack/packer/start/vim-table-mode"
  },
  ["vim-test"] = {
    loaded = true,
