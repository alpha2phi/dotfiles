...
_G.packer_plugins = {
  ...
  tagbar = {
    loaded = true,
    path = "/Users/joehannes/.local/share/nvim/site/pack/packer/start/tagbar"
  },
  ["targets.vim"] = {
    loaded = true,
