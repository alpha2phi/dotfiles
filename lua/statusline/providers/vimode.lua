...
function M.seperator()
	...
	if not u.buffer_not_empty() or vim.bo.filetype == "dashboard" then
		...
		u.GalaxyHi("ViModeSeperatorAlt", m_color, "purple")
		u.GalaxyHi("ViModeSeperatorInverse", "purple", m_color)
		u.GalaxyHi("ViModeSeperatorAltInverse", "purple", m_color)
		u.GalaxyFG("GitBranch", "base")
		u.GalaxyFG("FileSize", m_color)
		u.GalaxyHiB("FileName", "purple", "cyan")
